package concerrox.minecraft.effecticularity.core.render.entity.model
...
class SplashBottomModel<T : Entity>(root: ModelPart) : EntityModel<T>() {
    ...
    companion object {
        val MODEL_LAYER: ModelLayerLocation = ModelLayerLocation(Effecticularity.id("splash_bottom"), "main")
        @JvmStatic
