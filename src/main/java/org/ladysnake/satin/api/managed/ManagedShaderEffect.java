...
/**
 * A post-processing shader that is applied to the main RenderTarget
 * <p>
...
public interface ManagedShaderEffect extends UniformFinder {
     ...
     * such as RenderTarget objects, shaders objects and texture objects.
     ...
     * draw, draws the {@link Minecraft#getMainRenderTarget() main RenderTarget}'s texture
     * to intermediate {@link RenderTarget RenderTargets} as defined by the JSON files
     ...
     *
     * @param samplerName the name of the sampler uniform field in the shader source file and json
     * @param textureFbo  a RenderTarget which main texture will be used
     * @see #findSampler(String)
